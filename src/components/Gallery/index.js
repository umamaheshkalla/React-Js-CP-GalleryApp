...
class Gallery extends Component {
  ...
  getFilteredImage = () => {
    ...
    return <img className="images" alt={imageAltText} src={imageUrl} />
  }
    ...
    return (
      <div className="bg-container">
        ...
        <ul className="thumbnail-img-container">
          {imagesList.map(eachThumbnaillImage => (
            <ThumbnaillItem
              key={eachThumbnaillImage.id}
              imageDetails={eachThumbnaillImage}
              onClickThumbnailImage={this.onClickThumbnailImage}
              isActive={activeImageId === eachThumbnaillImage.id}
            />
          ))}
        </ul>
      </div>
